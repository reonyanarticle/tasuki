...
**次レイヤーへは、現在レイヤーの全子が統合ブランチへ取り込まれ、かつ統合ブランチが緑になってから進む。**
**未解決の open な補修の子がある間は次レイヤーへ進まない**(赤い base の上で次レイヤーの worker を起動すると、原因を作っていない子が self-verify と 2d を通せず、`max_iterations_per_gate` を無関係な理由で溶かす)。
