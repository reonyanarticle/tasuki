...
| ドキュメント | 内容 |
|---|---|
| [PHILOSOPHY.md](PHILOSOPHY.md) | 思想。受け手基準の抽象度、バトンパスの3値判定、コンテキスト境界、製造業・制御工学との対応 |
...
| [OPERATIONS.md](OPERATIONS.md) | 運用。`/tasuki:loop-init` と CI 生成、コスト管理・エスカレーション、メトリクス、回帰テスト |
| [INTEGRATION.md](INTEGRATION.md) | 橋渡し。外部 subagent・skill・検査ツールの接続点、プロジェクト直下アセットとの統合ルール |
